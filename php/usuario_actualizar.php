<?php
    ...
    if(verificar_datos("[a-zA-Z0-9@.]{4,50}",$usuario_admin)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    $check_admin=$check_admin->query("SELECT usuario_usuario,contrasena_usuario FROM usuarios WHERE usuario_usuario='$admin_usuario' AND id_usuario='".$_SESSION['id']."'");
